...
| 잡 | 스케줄 | 로그 | 락파일 | 산출물 |
|---|---|---|---|---|
| order 메인 | 20:15~20:55 일~목 | `/volume1/docker/testerp/data/auto_ingest.log` `[order]` | `/tmp/nas_order_ingest.lock` | `주문장_업로드_new/주문장_<날짜>/*.xls` ==8 |
